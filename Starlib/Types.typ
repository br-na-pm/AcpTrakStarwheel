...
TYPE
	...
	END_STRUCT;
	slStarPocketDestParType : 	STRUCT  (*Pocket Destination Parameters*)
		SendPosition : LREAL; (*Position to wait until sending shuttles*)
		TargetPosition : LREAL; (*Position to send shuttle to*)
	...
	END_STRUCT;
	slStarPocketReleaseParType : 	STRUCT  (*Release motion parameters*)
	...
	END_STRUCT;
	slStarPocketResizeStartParType : 	STRUCT  (*Parameters for resizing the shuttle at the start of synchronization*)
		ResizeParameters : McAcpTrakShResizeParamType; (*Starting resize parameters*)
	END_STRUCT;
	slStarPocketResizeEndParType : 	STRUCT  (*Parameters for resizing the shuttle at the end of synchronization*)
		Position : LREAL; (*Position to resize shuttles*)
		ResizeParameters : McAcpTrakShResizeParamType; (*Ending resize parameters*)
	END_STRUCT;
	...
	slStarPocketSyncInternalType : 	STRUCT  (*Internal Data*)
		...
		ElasticMoveVel : MC_BR_ElasticMoveVel_AcpTrak; (*Release the shuttle from synchronization*)
		RoutedMoveVel : MC_BR_RoutedMoveVel_AcpTrak; (*Send the shuttle to the destination*)
	...
	slStarPocketSyncStateEnum : 
		...
		slPOCKET_SYN_STATE_WAIT_SEND, (*Wait for shuttles to reach the send position*)
		slPOCKET_SYN_STATE_SEND, (*Send shuttle to destination*)
...
TYPE
	slStarSyncParType : 	STRUCT  (*Pocket Queue Parameters*)
		...
		ResizeStart : slStarPocketResizeStartParType; (*Starting resize parameters*)
		SyncPar : slStarPocketSyncParType; (*Synchronization parameters*)
		Release : slStarPocketReleaseParType; (*Release parameters*)
		ResizeEnd : slStarPocketResizeEndParType; (*Ending resize paramters*)
	...
	slStarSyncStateEnum : 
		...
		slSTAR_STATE_WAIT_BUFFER_START, (*Wait for buffers to initialize*)
